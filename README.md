...
A Python program for Rasperry Pi and an Arduino Sketch to gather data from sensors then control fans and servo motors on a custom solar heated wood drying kiln.
